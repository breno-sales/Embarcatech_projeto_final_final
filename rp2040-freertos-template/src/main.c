...
int main(){
    ...
    // strcpy(json_char.resp_retorno,mensagem);
    ...
    // xTaskCreate(task_uart_receiver, "Leitura_uart_rx", 4096, NULL, 1, NULL);    
    ...
    vTaskStartScheduler(); // Depois que o Scheduler começa, nada mais é lido no main()         // FUNCIONA OK!!!
    // loop_uart_rx();
    ...
    // while (1) {
        ...
        // enviar_dados_UART = true;
        // strcpy(json_char.resp_retorno,mensagem);
        // task_uart_transmitir(void *pvParameters);
